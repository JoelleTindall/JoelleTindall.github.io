      ...
      <div className="navholder">
        <nav id="stickynav" ref={navRef}>
          ...
          <div className="links">
            ...
            <a className="color2" onClick={() => handleNavScroll("projects")}>
              Projects
            </a>

            <a className="color3" onClick={() => handleNavScroll("contact")}>
              Contact
            </a>

            <Link className="color4" to="/otherstuff">
              Other Stuff
            </Link>
            ...
            <a
              className="color5"
              href="https://github.com/JoelleTindall"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
